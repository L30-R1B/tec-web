    ...
    useEffect(() => {
        ...
        const checkAdminAndLoadData = async () => {
            ...
            try {
                ...
                // Carregar prêmios, jogos e usuários
                await Promise.all([
    ...
    return (
        <div className="page-container">
            ...
            <main style={{ padding: '20px' }}>
                ...
                {/* Modal para Criar/Editar Prêmio */}
                {showForm && (
                    <div style={{
                        position: 'fixed',
                        top: 0,
                ...
                <div style={{ 
                    ...
                    <table style={{ 
                        ...
                        <tbody>
                            {prizes.map(prize => (
                                <tr key={prize.id_premio} style={{ 
                                    backgroundColor: prize.id_premio % 2 === 0 ? '#1a5f1a' : '#2d5016'
                                }}>
                                    <td style={{ 
                                        border: '1px solid #2d7a2d', 
                                        padding: '12px'
                                    ...
                                    <td style={{ 
                                        ...
                                        R$ {Number(prize.valor).toFixed(2)}
                                    </td>
                                    <td style={{ 
                                        border: '1px solid #2d7a2d', 
                                        padding: '12px'
                                    }}>
                                        {prize.jogo_data ? new Date(prize.jogo_data).toLocaleDateString('pt-BR') : `Jogo ${prize.id_jogo}`}
                                    </td>
                                    <td style={{ 
                                        border: '1px solid #2d7a2d', 
                                        padding: '12px'
                                    }}>
                                        {prize.usuario_nome || `Usuário ${prize.id_usuario}`}
                                    </td>
                                    <td style={{ 
                                        border: '1px solid #2d7a2d', 
                                        padding: '12px'
